...
gsap.to(' .work-sub-one',{
  scrollTrigger:{
    trigger:' .work-sub-one',
    toggleActions:'restart pause restart none'
  },
  duration:0.5,ease:'power1',y:-7,opacity:1,delay:0.3
}
...
// dropdown function
function myover1(){
  let act=document.querySelector(".sp-cd-op-1");
  act.innerHTML="&#8743;"
}
function myout1(){
  document.querySelector(".sp-cd-op-1").innerHTML="&#8744;"
}
function myover2(){
  let ret=document.querySelector(".sp-cd-op-2");
  ret.innerHTML="&#8743;"
}
function myout2(){
  document.querySelector(".sp-cd-op-2").innerHTML="&#8744;"
}
// cganging of images
 function myBest1(){
  document.querySelector(".flex-new-2").src="/img-rebranded/pexels-karolina-grabowska-4468010-alt.jpg";
 }
 function myBest2(){
 document.querySelector(".flex-new-2").src="/img-rebranded/pexels-rebrand-cities-1367276-alt.jpg" 
}
 function myBest3(){
  document.querySelector(".flex-new-2").src="/img-rebranded/pexels-kampus-production-5940708.jpg"
 }
 function myBest4(){
 document.querySelector(".flex-new-2").src="/img-rebranded/pexels-karolina-grabowska-4977446-alt.jpg"
 }
 function myBest5(){
  document.querySelector(".flex-new-2").src="/img-rebranded/pexels-sora-shimazaki-5668885-alt.jpg"
 }
 function myBest6(){
 document.querySelector(".flex-new-2").src="img-rebranded/pexels-karolina-grabowska-4977441-alt.jpg"
 }