...
// var acc=document.getElementById("another-accord");
// for(i=0;i<acc.length;i++){
//   acc[i].addEventListener("click", function(){
//     var subAcc= document.querySelector(".text-accord");
//     if(subAcc.style.display==="none"){
...
gsap.to('.sub-sec-image',{
  scrollTrigger:{
    trigger:'.sub-sec-image',
    toggleActions:'restart pause restart none'
  },
  duration:0.5,ease:'power1',scale:1,opacity:1,delay:0.3
}
...
gsap.to('.img-casual-1',{
  scrollTrigger:{
    trigger:'.img-casual-1',
    toggleActions:'restart pause restart none'
  },
  duration:0.5,ease:'power1',scale:1,opacity:1,delay:0.3
}
)
gsap.to('.img-casual-2',{
  scrollTrigger:{
    trigger:'.img-casual-2',
    toggleActions:'restart pause restart none'
  },
  duration:0.5,ease:'power1',scale:1,opacity:1,delay:0.3
}
)
gsap.to('.img-casual-3',{
  scrollTrigger:{
    trigger:'.img-casual-3',
    toggleActions:'restart pause restart none'
  },
  duration:0.5,ease:'power1',scale:1,opacity:1,delay:0.3
}
